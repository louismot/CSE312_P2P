          ...
          <div class="modal-body">
            ...
            <form method="post" action= "includes/transfer.inc.php">
              <div class="form-group form-check">
                ...
                <label class="form-check-label" for="transferwallet1">Bytecoin</label>
                <br>
                <input class="form-check-input" type="radio" name="wallet-transfer" id="withdrawwallet2" value="walletB">
                <label class="form-check-label" for="transferwallet2">Heavycoin</label>
                <br>
                <input class="form-check-input" type="radio" name="wallet-transfer" id="withdrawbank" value="bank">
                <label class="form-check-label" for="transferbank">USD Bank</label>
              </div>
          ...
          <div class="modal-body">
            ...
            <form method="post" action= "includes/deposit.inc.php">
              <div class="form-group form-check">
                ...
                <label class="form-check-label" for="depositwallet1">Bytecoin</label>
                <br>
                <input class="form-check-input" type="radio" name="wallet-deposit" id="depositwallet2" value="walletB">
                <label class="form-check-label" for="depositwallet2">Heavycoin</label>
              </div>
              <div class="form-group">
          ...
          <div class="modal-body">
            ...
            <form method="post" action= "includes/withdraw.inc.php">
              <div class="form-group form-check">
                ...
                <label class="form-check-label" for="withdrawwallet1">Bytecoin</label>
                <br>
                <input class="form-check-input" type="radio" name="wallet-withdraw" id="withdrawwallet2" value="walletB">
                <label class="form-check-label" for="withdrawwallet2">Heavycoin</label>
              </div>
              <div class="form-group">
